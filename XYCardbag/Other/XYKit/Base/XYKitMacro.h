...
#define iOS11 @available(iOS 11.0, *)   // XCode 9 才能使用
// 2.获得RGB颜色
...
// 公式：x = y * k；   ----> 坐标值 = 标尺 * 比率
#define k_widthRate ScreenW/750                               // 这两个用于px
#define k_heightRate ScreenH/1334
#define WidthFromPt(value) ((value) * ScreenW / 375.0f)       // 这两个用于pt
#define HeightFromPt(value) ((value) * ScreenH / 667.0f)
